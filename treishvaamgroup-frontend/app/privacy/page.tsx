        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          ...
          <div>
            ...
            <div className="bg-light-bg p-6 rounded-lg">
              ...
              <p className="text-text-secondary">Email: treishvaamgroup@gmail.com</p>
              <p className="text-text-secondary">Phone: +91 81785 29633</p>
              <p className="text-text-secondary">Location: Bangalore, Karnataka, India</p>
            </div>
          </div>

          <div className="border-t pt-8 mt-8">
            <p className="text-sm text-text-secondary">
              Last updated: January 2026. This privacy policy may be updated periodically to reflect changes in our practices.
            </p>
          </div>
        </div>
      </section>
