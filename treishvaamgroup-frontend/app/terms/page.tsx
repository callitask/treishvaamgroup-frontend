        ...
        <section className="py-20 bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
            ...
            <div>
              ...
              <p className="text-text-secondary leading-relaxed">
                These terms and conditions are governed by and construed in accordance with the laws of the jurisdiction in which Treishvaam Group operates, and you irrevocably submit to the exclusive jurisdiction of the courts in that location.
              </p>
            </div>

            <div className="border-t pt-8 mt-8">
              <p className="text-sm text-text-secondary">
                Last updated: December 2025. These terms of use may be updated periodically at our sole discretion.
              </p>
            </div>
          </div>
        </section>
